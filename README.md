# ml-07 Final Project - Elen Tesfai
...
## Dataset Used
For this project, the dataset used is the **Housing Prices Dataset** to predict home values based on features like square footage, location, and other relevant factors.
...
3. Develop a Jupyter Notebook (house_price_final.ipynb) structured as outlined above.  
